...
// setting the validation of our request headers (jwt auth)
...
class HeroRoutes extends BaseRoute {
    ...
    read() {
        return {
            ...
            config: {
                tags: ['api'],
                description: 'Should return an array of heroes',
                notes: 'use "pageSize" and "page" to paginate our records',
                validate: {
                    failAction,
                    query: {
    ...
    create() {
        return {
            ...
            config: {
                tags: ['api'],
                description: 'Should insert a hero',
                validate: {
                    failAction,
                    payload: {
    ...
    updateCompletely() {
        return {
            ...
            config: {
                tags: ['api'],
                description: 'Should update all fields from a hero',
                validate: {
                    failAction,
                    params: {
    ...
    patch() {
        return {
            ...
            config: {
                tags: ['api'],
                description: 'Should update specific fields from a hero',
                validate: {
                    failAction,
                    params: {
                        id: Joi.number().integer().required()
    ...
    delete() {
        return {
            ...
            config: {
                tags: ['api'],
                description: 'Should delete a hero using our id',
                validate: {
                    failAction,
                    params: {
                        id: Joi.number().integer().required()
